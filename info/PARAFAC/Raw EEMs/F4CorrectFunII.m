function [FI, maxEm, abs254, HIX, FrI] = F4CorrectFunII(Afile, ifile, uvfile, bfile, rfile, dilution_factor, correctedpath, uvlength)
...
em = 300:eminc:560; %Emission start wavelength:eminc:emission ending wavelength
...
RamanInc = .5; %The increment on your raman scan                     
...
B = dlmread(char(bfile), '', 1, 0); %Reads in Blank EEM file
...
A = dlmread(char(Afile), '\t', 1, 0);  % Reads in raw EEM file in .xls format.
